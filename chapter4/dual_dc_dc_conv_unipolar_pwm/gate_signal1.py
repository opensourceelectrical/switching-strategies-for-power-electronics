...
if t_clock > t1:    # t_clock is an internal varaible
    ...
    # Data storage
    pwm1_carr_signal1 = carr_signal1
    pwm1_carr_signal2 = carr_signal2
    pwm1_mod_signal = mod_index

    pwm1_s1_gate = s1_gate
    pwm1_s2_gate = s2_gate
    pwm1_s3_gate = s3_gate
    pwm1_s4_gate = s4_gate
